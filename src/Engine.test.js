...
test('get test results', () => {
  ...
  expect(engine(100)).toBe("one hundred");
  expect(engine(101)).toBe("one hundred and one");
  ...
  expect(engine(100100020)).toBe("one hundred million one hundred thousand and twenty");
});